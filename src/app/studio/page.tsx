      ...
      >
        ...
        <Reveal>
          ...
          <div style={{ marginBottom: '2.5rem' }}>
            ...
            <span className="font-serif block" style={{ fontSize: 'clamp(2.6rem, 5.5vw, 4.2rem)', fontWeight: 400, fontStyle: 'italic', lineHeight: 1.1, letterSpacing: '-0.03em', color: 'var(--amber)' }}>
              with us.
            </span>
          </div>
        </Reveal>
